...
public class L {
    ...
    private static void log(final int pType, final Throwable t, final Object s1, final Object... args) {
        ...
        if (true) {
            ...
            final String className = fullClassName.substring(fullClassName.lastIndexOf(",") + 1, fullClassName.length());
            ...
            if (s1 != null) {
                final String message = (args.length == 0) ? s1.toString() : String.format((String) s1, args);
